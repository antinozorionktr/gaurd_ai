...
class FaceRecognitionService:
    ...
    def search_face(self, image_base64: str, person_types=None, top_k=5):
        ...
        try:
            ...
            # Normalize keys expected by the router: include `confidence` and `match_found`
    ...
    def search_watchlist(self, image_base64: str) -> Dict[str, Any]:
        ...
        # Normalize keys expected by the router
        best_match_normalized = dict(best_match)
        best_match_normalized["confidence"] = best_match_normalized.get("score")
        ...
        return {
            ...
            "best_match": best_match_normalized,
            "alert_person_id": best_match_normalized.get("person_id"),
            "confidence": best_match_normalized.get("confidence"),
            "details": best_match_normalized,
        }
